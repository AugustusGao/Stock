...
;(function () {
    ...
    QaDefault.prototype = {
        ...
        */
        ...
        GetJGMJ: function () {
            ...
            $.ajax({
                ...
                success: function (json) {
                    ...
                    //名家
                    $.ajax({
                        url: "//cmsdataapi.eastmoney.com/api/author/GetAuthorArticleByIds?channelIds=9&pageIndex=1&pageSize=20",
                        dataType: "jsonp",
                        jsonp: "cb",
        ...
        bindBkList: function () {
            //新版所属板块
            var url = commonApi + "api/qt/slist/get?ut=fa5fd1943c7b386f172d6893dbfba10b&spt=3&pi=0&pz=5&po=1&fields=f14,f3,f128,f12,f13,f100,f102,f103&secid=" + _this._Market_10 + "." + _this._Code;
        ...
        RenderHistoryList: function (ids) {         
            ...
            var _url = commonApi + 'api/qt/ulist.np/get?fields=f12,f13,f14,f2,f1,f3,f152&invt=2&ut=fa5fd1943c7b386f172d6893dbfba10b';
        ...
        GetFbFj: function (cd) {
            ...
            //新版分时成交
            $.ajax({
                url:"//push2.eastmoney.com/api/qt/stock/details/get?ut=fa5fd1943c7b386f172d6893dbfba10b&fields1=f1,f2,f3,f4&fields2=f51,f52,f53,f54,f55&pos=-11&secid=" + _this._Market_10 +"."+ _this._Code,
                dataType: "jsonp",
                jsonp: "cb",
                beforeSend: function () {
        ...
        GetFbFj_sse: function (cd) {
            var url="//"+(Math.floor(Math.random() * 99) + 1)+".push2.eastmoney.com/api/qt/stock/details/sse?ut=fa5fd1943c7b386f172d6893dbfba10b&fields1=f1,f2,f3,f4&fields2=f51,f52,f53,f54,f55&pos=-11&secid=" + _this._Market_10 +"."+ _this._Code;
        ...
        GetPKYD: function (code, market) {
            $.ajax({
                ...
                url: commonApi + "api/qt/pkyd/get?ut=fa5fd1943c7b386f172d6893dbfba10b&lmt=5&fields=f1,f2,f3,f4,f5,f6,f7&secids=" + _this._Market_10 + "." + _this._Code,
                dataType: "jsonp",
                scriptCharset: "utf-8",
                jsonp: "cb",
        ...
        GetAllPKYD: function () {
            $.ajax({
                ...
                url: commonApi + "api/qt/pkyd/get?ut=fa5fd1943c7b386f172d6893dbfba10b&lmt=5&fields=f1,f2,f3,f4,f5,f6,f7&secid=" + _this._Market_10 + "." + _this._Code,
                dataType: "jsonp",
                scriptCharset: "utf-8",
                jsonp: "cb",
                success: function (msg) {
        ...
        formatymd:function(str){
            if (!str || str =='-') { return "" };
            var back = Number(str.split('T')[0].replace(/-/g, ''));
            return back
        },
                ...
                success:function(data){
                    if(data && data[0]){
                        ...
                        //申购当天
                            ...
                            //中签号公布日 ZQHDATE                       
                            if (infos.ZQHDATE && infos.ZQHDATE != '-' && infos.LISTDATE == '-') {
                            ...
                            if (infos.LISTDATE && infos.LISTDATE != '-') {
                                var listtimeNum = that.formatymd(infos.LISTDATE);
                                //当前日期小于上市日期
                                if (listtimeNum > curtimeNum) {
                                    $("#relation-container").html('<div class="kzz-wrap"><a class="zzname" target="_blank" href="//data.eastmoney.com/kzz/detail/' + infos.BONDCODE + '.html">' + infos.CORRESNAME + '</a><span class="zzlab">债券代码:' + infos.BONDCODE + '</span><span class="zzdetail">上市日期:' + that.formatymd(infos.LISTDATE) + '</span></div>')
                                } else {
                                    //上市当天及之后
        ...
        */
        DisQuote: function () {
            ...
            if ((window.GetTimeZoneInfo || window.quoteIsFirst)) {
                ...
                // console.info(commonApi)
                //var sjs = Math.random().toString().replace('.', '');
                jQuery.ajax({
                    // url: "http://nuff.eastmoney.com/EM_Finance2015TradeInterface/JS.ashx?id=" + _this._Code + "" + _this._Market + "&token=" + window.token,
                    // url:"http://61.152.230.207/api/qt/stock/get?ut=fa5fd1943c7b386f172d6893dbfba10b&fltt=2&secid=" + _this._Market_10 +"."+ _this._Code,
                    ...
                    url: commonApi + "api/qt/stock/get?ut=fa5fd1943c7b386f172d6893dbfba10b&invt=2&fltt=2&fields=f43,f57,f58,f169,f170,f46,f44,f51,f168,f47,f164,f163,f116,f60,f45,f52,f50,f48,f167,f117,f71,f161,f49,f530,f135,f136,f137,f138,f139,f141,f142,f144,f145,f147,f148,f140,f143,f146,f149,f55,f62,f162,f92,f173,f104,f105,f84,f85,f183,f184,f185,f186,f187,f188,f189,f190,f191,f192,f107,f111,f86,f177,f78,f110,f262,f263,f264,f267,f268,f250,f251,f252,f253,f254,f255,f256,f257,f258,f266,f269,f270,f271,f273,f274,f275,f127,f199,f128,f193,f196,f194,f195,f197,f80,f280,f281,f282,f284,f285,f286,f287,f292&secid=" + _this._Market_10 + "." + _this._Code,  
                    scriptCharset: "utf-8",
                    dataType: "jsonp",
                    jsonp: "cb",
                    success: function (json) {   
        ...
        DisQuote_sse: function () {
            ...
            var url = tsApi + "api/qt/stock/sse?ut=fa5fd1943c7b386f172d6893dbfba10b&fltt=2&fields=f43,f57,f58,f169,f170,f46,f44,f51,f168,f47,f164,f163,f116,f60,f45,f52,f50,f48,f167,f117,f71,f161,f49,f530,f135,f136,f137,f138,f139,f141,f142,f144,f145,f147,f148,f140,f143,f146,f149,f55,f62,f162,f92,f173,f104,f105,f84,f85,f183,f184,f185,f186,f187,f188,f189,f190,f191,f192,f206,f207,f208,f209,f210,f211,f212,f213,f214,f215,f86,f107,f111,f86,f177,f78,f110,f262,f263,f264,f267,f268,f250,f251,f252,f253,f254,f255,f256,f257,f258,f266,f269,f270,f271,f273,f274,f275,f292&secid=" + _this._Market_10 + "." + _this._Code; 
            var evtSource = new EventSource(url);
            evtSource.onmessage = function (msg) {
                //console.log(msg.data)
                ...
                if(json.data){
                    ...
                    if (json.data.f292 == 8) {
                        ...
                        if(json.data.f43 != undefined && json.data.f43 != '-'){
                            ...
                            _this.$("rgt1").innerHTML = json.data.f43; _this.$("rgt1").className = udcls(json.data.f43,yestoday);//最新价
                    ...
                    if(json.data.f39&&json.data.f40){
                        _this.$("gts1a").innerHTML = json.data.f39.toFixed(2); _this.$("gts1b").innerHTML = json.data.f40; _this.$("gts1a").className = udcls(json.data.f39, yestoday);                         
...
function phrankk(){
    ...
    var url = commonApi + "api/qt/slist/get?pi=0&pz=5&po=1&spt=4&fields=f2,f12,f13,f14,f15,f3,f4,f6,f5,f11,f10&ut=fa5fd1943c7b386f172d6893dbfba10b&secid=" + _this._Market_10 + "." + _this._Code + "&fid=f3";
    $.ajax({
        url: url,
        dataType: "jsonp",
        scriptCharset: "utf-8",
...
function phrank(def) {
    ...
    var url = commonApi + "api/qt/slist/get?pi=0&pz=5&po=1&spt=4&fields=f2,f12,f13,f14,f2,f3,f4,f6,f5,f11,f10&ut=fa5fd1943c7b386f172d6893dbfba10b&secid=" + _this._Market_10 + "." + _this._Code + "&fid=" + fids[def];
    $.ajax({
        url: url,
        dataType: "jsonp",
        scriptCharset: "utf-8",
